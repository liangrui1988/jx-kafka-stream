 ...
 *
 */
public class TopGoodsBrowseLambda {
	static Logger logger = LoggerFactory.getLogger(TopGoodsBrowseLambda.class);
	...
	public static void main(final String[] args) throws Exception {
		...
		final KafkaStreams streams = buildTopArticlesStream(bootstrapServers, schemaRegistryUrl, "/tmp/kafka-streams");
		streams.cleanUp();
		streams.start();
	...
	static KafkaStreams buildTopArticlesStream(final String bootstrapServers, final String schemaRegistryUrl,
		...
		// 解析avsc文件的Schema
		final InputStream statsSchema = TopGoodsBrowseLambda.class.getClassLoader()
